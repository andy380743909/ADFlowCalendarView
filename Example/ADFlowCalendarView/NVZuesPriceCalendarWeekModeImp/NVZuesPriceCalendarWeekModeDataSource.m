...
@implementation NVZuesPriceCalendarWeekModeDataSource
...
- (void)registerViewClassToFlowCalendar:(ADFlowCalendarView *)calendarView{
    ...
    [calendarView.collectionView registerClass:[NVZuesPriceCalendarWeekModeDayCell class] forCellWithReuseIdentifier:cellReuseIdentifier];
...
- (ADFlowCalendarDayCell *)flowCalendarView:(ADFlowCalendarView *)flowCalendarView dayCellAtIndexPath:(NSIndexPath *)indexPath flowCalendarSectionData:(ADFlowCalendarSectionData *)sectionData
{
    ...
    NVZuesPriceCalendarWeekModeDayCell *cell = (NVZuesPriceCalendarWeekModeDayCell *)[super flowCalendarView:flowCalendarView dayCellAtIndexPath:indexPath flowCalendarSectionData:sectionData];
    ...
    cell.weekdayLabel.text = [self weekdaySymbolForWeekday:[dayModel weekday]];
...
//                cell.topleftFlagImgV.hidden = YES;
    ...
    if (indexPath.item == 0) {
        ...
        [cell setBorderWithStyle:styleLeft forEdge:UIViewBorderEdgeLeft];
    }
